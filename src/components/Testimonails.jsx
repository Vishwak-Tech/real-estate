...
<div className='flex flex-nowrap justify-center gap-8 overflow-x-auto px-4 no-scrollbar'>
    {testimonialsData.map((testimonial, index)=>(
    <div key={index} className='max-w-[340px] flex-shrink-0 border shadow-lg rounded px-8 py-12 text-center'>
